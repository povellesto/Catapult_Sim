...
GRAPHING_DELAY = 45 # how many milliseconds to wait before drawing the next point
...
#Calculators
def calculateA():
    print("Welcome to the Calculating Addition, for now it can only do addition")
    x = input("First number: ")
    y = input("Second number: ")    
    print("The sum of ", x, " and ", y, " is ", x+y, ".")
def calculateD():
    print("Welcome to the Calculating Division, for now it can only do Division")
    x = input("First number: ")
    y = input("Second number: ")    
    print("The sum of ", x, " and ", y, " is ", x/y, ".")
def calculateM():
    print("Welcome to the Calculating Muiltipication, for now it can only do Muiltipication")
    x = input("First number: ")
    y = input("Second number: ")    
    print("The sum of ", x, " and ", y, " is ", x*y, ".")
def calculateP():
    print("Welcome to the Calculating Powers, for now it can only do Powers")
    x = input("First number: ")
    y = input("Power: ")    
    print("The sum of ", x, " and ", y, " is ", x**y, ".")                                                                    
...
class Grapher(Frame):
    ...
    def draw_axes(self):
        self.draw_line(X_START, 0, X_END, 0, color="black")
        self.draw_line(0, Y_START, 0, Y_END, color="black")
    ...
    def createWidgets(self):
        self.master.wm_title("LQ Calculator")
        self.master.configure(background='')
        ...
        #Adding the calculator buttons to activate the calculators
        self.calculator_button = Button(self, text="Calculating Addition", command= calculateA)
        self.calculator_button.grid(row=0, column=2)
        self.calculator_button = Button(self, text="Calculating Division", command= calculateD)
        self.calculator_button.grid(row=0, column=1)
        self.calculator_button = Button(self, text="Calculating Muiltipication", command= calculateM)
        self.calculator_button.grid(row=0, column=0)
        self.calculator_button = Button(self, text="Calculating Subtraction", command= calculateP)
        self.calculator_button.grid(row=1, column=0)
        self.calculator_button = Button(self, text="Calculating Powers", command= calculateP)
        self.calculator_button.grid(row=1, column=1)
        ...
        self.w = Label(self, text="a")
        self.w.grid(row=5, column=0)
        self.e = Label(self, text="b")
        self.e.grid(row=5, column=1)
        self.r = Label(self, text="c")
        self.r.grid(row=5, column=2)
        self.define = Label(self, text="For graphing quads you can either do linear functions and quadrants.")
        self.define.grid(row=4, column=9)
        self.define = Label(self, text="If you want to do linear fuctions enter in the a box,")
        self.define.grid(row=5, column=9)
        self.define = Label(self, text="then enter different numbers in each b and c.")
        self.define.grid(row=6, column=9)
        self.define = Label(self, text="Graphing Linear Functions and Quadrants")
        self.define.grid(row=1, column=9)
        self.define = Label(self, text="Ax**2 + Bx + C")
        self.define.grid(row=5, column=4)
